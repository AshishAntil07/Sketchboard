...
textBtn.addEventListener('click', e => {
  ...
  textbox.parentElement.addEventListener('focusout', e => {
    const textElem = create('text', true);
    textElem.innerHTML = textbox.value;
    textElem.x = getStyle(textbox.parentElement, 'left')-getStyle(sideBar, 'width');
    textElem.y = getStyle(textbox.parentElement, 'top')-getStyle(topBar, 'height');
